...
set :user, "user21712109"


# password to login to the target server
set :password, "NeJvMZaR5S"
...
# repository location
set :repository, "https://github.com/dummhupe/bowlingdb"
...
set :deploy_to, "/home/user21712109/rails1"
...
namespace :railshoster do
  ...
  task :appurl do
    ...
    puts "\nhttp://user21712109-1.ny.railshoster.de"    
    puts "\n"
  end
end
