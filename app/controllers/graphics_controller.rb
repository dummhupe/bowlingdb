class GraphicsController < ReportController
  ...
  def player_by_game
	...
	if scores and scores.to_a.size > 1
  ...
  def player_by_avg_match
    ...
    @player_restrictions.each do |player_id|
      ...
      if @regression and @games[player_id] and @games[player_id].to_a.size > 1
  ...
  def player_by_location
    ...
    @location_restrictions.each do |location_id|
      ...
      if @regression and @games[location_id] and @games[location_id].to_a.size > 1
